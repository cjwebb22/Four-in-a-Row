...
### Description:
This project is a four-in-a-row command line game. This idea was from an optional assignment for FIT1045 at Monash. Essentially, the assignment was to make a command line four-in-a-row game. The only similarity between this project and the assignment is that they are both four-in-a-row command line games, and the assignment represented the board similarly. That's why I can put this code on GitHub. I added several new features, including a solo game using a minimax algorithm.
